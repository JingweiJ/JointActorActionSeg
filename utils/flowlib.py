...
def save_flow_image(flow, image_file, verbose=True):
    """
    ...
    :return: None
    """
    flow_img = flow_to_image(flow, verbose)
...
def flow_to_image(flow, verbose=True):
    """
...
def warp_image(im, flow, method='nearest'):
    """
    ...
    for i in range(im.shape[2]):
        ...
        new_channel = interpolate.griddata(points, values, xi, method=method)
